...
class Contact extends Component {
  ...
  validate(firstname,lastname,telnum,email){
    ...
    errors.firstname="First name should be =<15"
    if(this.state.touched.lastname&&lastname.length<3)
      errors.firstname="Last name should be >=3"
    else if(this.state.touched.lastname&&lastname.length>15)
    errors.firstname="Last name should be =<15"
    const reg= /^\d+$/;
    if(this.state.touched.telnum&&!reg.test(telnum))
      errors.telnum="Tel. must contain only numbers"
